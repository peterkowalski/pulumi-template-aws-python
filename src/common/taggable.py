"""List of taggable AWS resources."""


def is_taggable(resource) -> bool:
    """Check if AWS resource supports tagging.

    Returns:
        True if the given resource type is an AWS resource that supports tags.
    """
    return resource in taggable_resource_types
